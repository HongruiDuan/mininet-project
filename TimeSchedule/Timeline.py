...
def topology():
    ...
    DU1 = net.addStation('DU1', position='15,15,0', ip='10.0.0.3', mac='00:00:00:00:00:03')

    DU2 = net.addStation('DU2', position='15,15,0', ip='10.0.0.4', mac='00:00:00:00:00:04')
    ...
    net.addLink(DU1, cls=adhoc, ssid='adhocNet', mode='g', channel=5, ht_cap='HT40+')
